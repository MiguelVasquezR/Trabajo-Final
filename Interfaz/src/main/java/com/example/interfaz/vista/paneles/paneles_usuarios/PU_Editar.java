...
import com.example.interfaz.vista.ventanas.Ventana_Password;
...
public class PU_Editar extends BorderPane{

    Label[] labels;
    TextField tfClave, tfNombre, tfApellido, tfCorreo, tfNúmero, tfCalle, tfColonia, tfNumeroDir, tfCiudad, tfUsuario, tfBuscar;
    ...
    private Pane barraSuperior(){
        ...
        tfBuscar.setPromptText("Ingresa nombre de Usuario");
    ...
    private void datosPer(){
        ...
        p.getChildren().addAll(tfClave, fc_nac ,tfNombre, tfApellido, tfCorreo, tfNúmero);
    }
    ...
    private void datosUsu(){
        ...
        psContrase.setOnMouseClicked(evt->{
            Ventana_Password vp = new Ventana_Password();
            vp.show();
        });

        p.getChildren().addAll(tfUsuario, psContrase);
    }
    ...
    private void guardarDatos(){
        if(verificacion()){
            ...
            usuario.encriptar(psContrase.getText());
            ControladorUsuario controladorUsuario = new ControladorUsuario();
            controladorUsuario.editarUsuario(persona, direccion, usuario);
        }else{
            addOyentesCampos();
        }
    }
    ...
    private void buscar(){
        ...
        cliente.Usuario("BUSCAR", String.valueOf(clave), this, null);
    }

    public void llenarCampos(Persona persona, Direccion direccion, Usuario usuario){
        ...
        psContrase.setText(usuario.getContrasena());
