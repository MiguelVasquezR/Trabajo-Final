...
public class PPR_Agregar extends Pane {

    Label[] labels;
    TextField tfClave, tfNombre, tfApellido, tfCorreo, tfNúmero, tfCalle, tfColonia, tfNumeroDir, tfCiudad, tfCompañia;
    ...
    private void datosProvee(){
        ...
        getChildren().addAll(tfCompañia, fecha_entrega, fecha_recoge);
    }
    ...
    private void guardarDatos(){
        if(verificacion()){
            ...
            if (controladorProveedor.agregarProveedor(persona, direccion, proveedor)){
